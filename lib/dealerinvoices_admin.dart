...
// this is 
class DealerInvoicesAdmin extends StatefulWidget {
  // user object is sent from previous screen
  const DealerInvoicesAdmin(this.dealerUser);
  final Dealers dealerUser;
  
  @override
  _DealerInvoicesAdminState createState() => _DealerInvoicesAdminState();
}

class _DealerInvoicesAdminState extends State<DealerInvoicesAdmin> with TickerProviderStateMixin {
...
// print('users count ${allRows.length}');
 ...
 // no profile exists
        ...
        refreshUserDealerInvoicesAdmin(context);
    }
    ...
    // find the user
    void refreshUserDealerInvoicesAdmin(BuildContext context) async {
                          ...
                          children: <Widget>[
                            ...
                            // child: CardRound(Palette.lightBackground, Column(
                              ...
                              children: <Widget>[
                                ...
                                //     onPressed: () => updateDealerInvoicesAdmin(context),
                                //   ),
  ...
  // Refresh profile
  // refreshDealerInvoicesAdmin(BuildContext context) async {
