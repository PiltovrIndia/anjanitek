...
// this is 
class InvoicesAllAdmin extends StatefulWidget {
  
  
  @override
  _InvoicesAllAdminState createState() => _InvoicesAllAdminState();
}

class _InvoicesAllAdminState extends State<InvoicesAllAdmin> with TickerProviderStateMixin {

  late AnimationController _controller;
  late AnimationController _controllerCards;
  static String name = '', role='', id='', accountName='',dealerId='',salesId='';
 ...
 // no profile exists
        ...
        if(prefs.containsKey(Constants.name)){
          ...
          isActive = prefs.get(Constants.isActive) as int;
            ...
            if(prefs.get(Constants.role).toString().toLowerCase() == Constants.dealer.toLowerCase()){
        ...
        refreshUserInvoicesAllAdmin(context);
    }
    ...
    // find the user
    void refreshUserInvoicesAllAdmin(BuildContext context) async {
      ...
      if(await checkInternetConnectivity()){
        ...
        // API call
        // print("${APIUrls.amount}${APIUrls.pass}/U6/$role/$id");
        // print("${APIUrls.amount}${APIUrls.pass}/U4/$offset");
        // var result = await get(Uri.parse(APIUrls.getUrl("${APIUrls.amount}${APIUrls.pass}/U4/$offset", queryParams)), headers: {"Accept": "application/json"});
        var result = await get(Uri.parse(APIUrls.getUrl("${APIUrls.amount}${APIUrls.pass}/U6/$role/$id", queryParams)), headers: {"Accept": "application/json"});
        // print(result.body);
                          ...
                          children: <Widget>[
                            ...
                            // child: CardRound(Palette.lightBackground, Column(
                              ...
                              children: <Widget>[
                                ...
                                //               Text('Back', style: GoogleFonts.montserrat(textStyle: Theme.of(context).textTheme.bodyLarge, fontWeight: FontWeight.w500), ),
                                //             ],
                                //           ),
                                //         ),
                                ...
                                //     Text('        ', style: GoogleFonts.montserrat(textStyle: Theme.of(context).textTheme.headlineSmall, fontWeight: FontWeight.bold), ),
                                //   ],
                                // ),
                                ...
                                //   child: Text('Invoices - ${invoicesList.length}', style: GoogleFonts.montserrat(textStyle: Theme.of(context).textTheme.headlineSmall, fontWeight: FontWeight.bold), ),
                                // ),
                                // sizedBox(8),
                                ...
                                Container(
                                  ...
                                  Row(
                                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                    children: [
                                    Text('Invoices - ${invoicesList.length}', style: GoogleFonts.montserrat(textStyle: Theme.of(context).textTheme.headlineSmall, fontWeight: FontWeight.bold), ),
                                    IconButton(
  ...
  // Refresh profile
  // refreshInvoicesAllAdmin(BuildContext context) async {
...
Widget invoiceCard(int position){
  return InkWell(
    ...
    children: <Widget>[
      ...
      InkWell(
        onTap: () {
            Navigator.push(context, MaterialPageRoute(builder: (context) => DealerDetails(id, name, invoicesList[position].billTo!, invoicesList[position].billTo!)));
            // Navigator.push(context, MaterialPageRoute(builder: (context) => DealerDetailsAdmin(invoicesList[position].billTo!)));
        },
        child: 
            Text("VIEW DEALER –>", style: GoogleFonts.inter(textStyle: Theme.of(context).textTheme.bodySmall, letterSpacing: 1, fontSize: 14, fontWeight: FontWeight.bold, color: Colors.blue.shade600)),
      ),
      sizedBox(4),
