...
class _SalesDealers2State extends State<SalesDealers2> {
  ...
  void getStudents() async {
      ...
      var searchBy = 'U8';
      // if(role!.toLowerCase() == Constants.superAdmin.toLowerCase()){
      //   searchBy = 'U7';
      // }
      // if(role!.toLowerCase() == Constants.salesManager.toLowerCase() || role!.toLowerCase() == Constants.salesExecutive.toLowerCase()){
      //   searchBy = 'U8';
      // }
      ...
      body: SafeArea(
        ...
        children: <Widget>[
              ...
              Container(
                    ...
                    child: dealersList.isNotEmpty ?
                    (dealersList[0].role == 'Dealer') ?
                    Text('Dealers - ${dealersList.length}', style: GoogleFonts.montserrat(textStyle: Theme.of(context).textTheme.bodyLarge, color: Colors.black, fontWeight: FontWeight.bold, fontSize: 20), )
                    : Text('Sales - ${dealersList.length}', style: GoogleFonts.montserrat(textStyle: Theme.of(context).textTheme.headlineSmall, color: Colors.black, fontWeight: FontWeight.bold, fontSize: 20), )
                          : sizedBox(0)  
              ),
              // sizedBox(16),
              sizedBox(4),
              dealersList.isNotEmpty ?
              Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(" ${widget.selectedSalesPersonName}", style: GoogleFonts.inter(textStyle: Theme.of(context).textTheme.bodyLarge, color: Colors.black, fontWeight: FontWeight.w500)),
            ...
            _filteredUsers.isEmpty ? 
                  ...
                  Center(
                      child: Column(
                        ...
                        children: [
                          Icon(PhosphorIconsRegular.userFocus, color: Color(0xFFAAAAAA), size: 32, ),
                          sizedBox(8),
