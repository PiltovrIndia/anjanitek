...
class AnjaniTekApp1 extends StatefulWidget {
  @override
  AnjaniTekApp1State createState() => AnjaniTekApp1State();
}

class AnjaniTekApp1State extends State<AnjaniTekApp1> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        child: Column(
          children: [
            Container(
              ...
              //     colors: [Color(0xFFFF8B59), Color(0xFFF36C31)],
      ...
      //         right: 40,
      //         child: Text(
      //           "Assign tasks, set priorities,\nand monitor your team’s progress.",
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // (refreshCheckProgress && productTags.length == 0) ? 
                  // Center(
                  //   child: Column(
                  ...
                  //                   ],
                  //         ),
                  //         child: Text(sizes[index].name!, style: GoogleFonts.inter(textStyle: Theme.of(context).textTheme.bodyLarge, color: Colors.black87, fontWeight: FontWeight.bold, fontSize: 14), ),
                  //       );
