...
// print('users count ${allRows.length}');
    ...
    if (prefs.containsKey(Constants.name)) {
      setState(() {
        ...
        _imageUrl =
            "https://firebasestorage.googleapis.com/v0/b/anjanitek-communications.firebasestorage.app/o/${prefs.get(Constants.id) as String}.webp?alt=media";
  ...
  void refreshUserProfile(BuildContext context) async {
    ...
    var result = await get(
        Uri.parse(APIUrls.getUrl(
            "${APIUrls.user}${APIUrls.pass}/U14/$mobile", queryParams)),
    ...
    if (jsonObject['status'] == 200) {
      ...
      showToast(context, "Your profile is not active", Constants.error);
      signOutUser();
    } else {
      setState(() {
        refreshCheckProgress = false;
  ...
  Future<void> _uploadImage(File image) async {
    ...
    try {
      final storageRef = FirebaseStorage.instanceFor(
              bucket: "gs://anjanitek-communications.firebasestorage.app")
          .ref();
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                          ...
                          children: <Widget>[
                            ...
                            ScaleTransition(
                              scale: CurvedAnimation(
                                ...
                                curve: Curves
                                    .ease, // Use Curves.easeIn for ease-in animation
                              ),
                                ...
                                child: Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      _isUploading
                                          ...
                                          : getImage(
                                              _imageUrl, name, 100.0, 100.0),

                                      // sizedBox(16),
                                      ElevatedButton(
                                        style: ElevatedButton.styleFrom(
                                          backgroundColor: Color(
                                              0xFF048563), // Dark background color
                                          foregroundColor: Color(0xFFFFFFFF),
                                          padding: EdgeInsets.symmetric(
                                              horizontal: 10,
                                              vertical: 2), // Smaller padding
                                          minimumSize:
                                              Size(0, 24), // Minimum height
                                      ...
                                      Row(
                                        children: [
                                          const HugeIcon(
                                              ...
                                              color: Colors.black,
                                              size: 24),
                                          // HugeIcon(HugeIcons.strokeRoundedMessage01, color: Colors.black, size: 24),
                                          const SizedBox(width: 16),
                                          Expanded(
                                            child: Column(
                                                crossAxisAlignment:
                        ...
                        Row(
                            ...
                            children: [
                              Text('Reach out to us to update any details',
                            ...
                            child: Column(
                              children: [
                                    ...
                                    if (Platform.isAndroid)
                                      {
                                        ...
                                        launchUrl(
                                          Uri.parse(
                                              'https://play.google.com/store/apps/details?id=com.anjanitek'),
                                          mode: LaunchMode
                                    ...
                                    else if (Platform.isIOS)
                                      {
                                        ...
                                        launchUrl(Uri.parse(
                                            'https://apps.apple.com/app/id6498621857'))
                                      }
                                  },
                                ),
                                // ),
                                ...
                                InkWell(
                                  ...
                                  onTap: () => {
                                    facebookUrl = Uri.parse(
                                        'https://www.instagram.com/anjanitek/'),
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                          '${Platform.isAndroid ? Constants.sc_app_version : Constants.sc_app_version_ios}',
                                          style: GoogleFonts.inter(
                                              textStyle: Theme.of(context)
                                                  .textTheme
                                                  .bodyMedium,
  ...
  signOutUser() async {
    ...
    await Navigator.pushReplacement(
        context, MaterialPageRoute(builder: (context) => AnjaniTekApp2()));
  ...
  refreshProfile(BuildContext context) async {
    ...
    setState(() {
      updateMsg = 'Checking for updtes. Please wait...';
    });
            ...
            return Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  sizedBox(16),
                  Text('Update your personal mobile number',
                      style: GoogleFonts.inter(
                          textStyle: Theme.of(context).textTheme.bodyMedium)),
                  sizedBox(16),
                  Column(
                      ...
                      children: [
                        TextFormField(
                          ...
                          focusNode:
                              otpFocusNode, // Associate the FocusNode with the TextFormField
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText:
                                (mobile.length > 2) ? mobile : 'Phone number',
                          ),
                          validator: (value) {
                            // validator function is called on calling form validate() method
                            if (value!.isEmpty) {
                              print('ok');
                              return '';
                            }
                        ...
                        sizedBox(4),
                        Text(
                          'Enter the phone number that is active and in use.',
                          style: GoogleFonts.inter(
                              textStyle: Theme.of(context).textTheme.bodySmall),
                        ),
                        Text(
                          'Don\'t enter country code like +91.',
                          style: GoogleFonts.inter(
                              textStyle: Theme.of(context).textTheme.bodySmall),
                        ),
                        sizedBox(8),
                        ...
                        sizedBox(4),
                        updatePhoneNumberCheckProgress
                            ? const AppProgress(
                                height: 20,
                                width: 20,
                              )
                            : sizedBox(0),
                        phoneErrorMsg.isNotEmpty
                            ? Text(
                                phoneErrorMsg,
                                style: GoogleFonts.inter(
                                    textStyle:
  ...
  void updatePhoneNumber(BuildContext context1, String newPhoneNumber) async {
    ...
    if (await checkInternetConnectivity()) {
      ...
      var result = await get(
          Uri.parse(APIUrls.getUrl(
              "${APIUrls.user}${APIUrls.pass}/U15/$id/$newPhoneNumber",
              queryParams)),
          headers: {"Accept": "application/json"});
  ...
  void verifyUser(BuildContext context1) async {
    // query parameters
    Map<String, String> queryParams = {"id": id, "mobileNumber": mobile};

    // API call
    var result = await get(
        Uri.parse(APIUrls.getUrl(APIUrls.verifyUser, queryParams)),
        headers: {"Accept": "application/json"});
    ...
    if (jsonObject['status'] == 200) {
      ...
      setState(() {
        updateMsg =
            'Something went wrong! Sign out and Sign in for smoother experience!';
      });
    }
  }
 ...
 */
    ...
    setState(() {
      updateMsg =
          'Your profile is refreshed. Reopen the app for smooth experience!';
    });
  }
}
