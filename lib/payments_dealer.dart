...
class PaymentsDealer extends StatefulWidget {
  ...
  @override
  _PaymentsDealerState createState() => _PaymentsDealerState();
}

class _PaymentsDealerState extends State<PaymentsDealer> with TickerProviderStateMixin {
...
// print('users count ${allRows.length}');
 ...
 // no profile exists
    ...
    // find the user
    void refreshUserPaymentsDealer(BuildContext context) async {
      ...
      if(await checkInternetConnectivity()){
        ...
        var result = await get(Uri.parse(APIUrls.getUrl("${APIUrls.amount}${APIUrls.pass}/U3/$id/$offset", queryParams)), headers: {"Accept": "application/json"});
        // print(result.body);
  ...
  // Refresh profile
  // refreshPaymentsDealer(BuildContext context) async {
